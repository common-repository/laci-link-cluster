...
foreach ( $posts_data as $post_data ) :
    ...
    <div class="laci-container-diff-cat-item laci-container-cat-item" data-id="<?php echo esc_html( $post_id_data ); ?>">
        ...
        <div class="laci-mid-section" data-current-excerpt="0">
            ...
            <div class="laci-diff-cat-action">
                <span class="laci-diff-cat-num-results"><?php echo ( esc_html( $total_results ) . esc_html__( ' - Search Results', 'laci-link-cluster' ) ); ?></span>
                <button class="button laci-diff-cat-content-previous" disabled><?php esc_html_e( '<< Previous', 'laci-link-cluster' ); ?></button>
                <button class="button laci-diff-cat-content-next" <?php echo esc_attr( $total_results < 2 ? 'disabled' : '' ); ?>><?php esc_html_e( 'Next >>', 'laci-link-cluster' ); ?></button>
                <button class="button laci-diff-cat-content-edit"><?php esc_html_e( 'Edit & Place Link', 'laci-link-cluster' ); ?></button>
